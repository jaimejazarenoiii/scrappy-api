...
| `PATCH /trips/{tripId}/members/{memberId}`  | OWNER, MANAGER           | Update member role (`DRIVER`, `HELPER`, `BUYER`, `SUPERVISOR`)      |
| `DELETE /trips/{tripId}/members/{memberId}` | OWNER, MANAGER           | Remove member from Draft trip                                       |
