...
/**
 * Handles a single multipart `file` field for photo uploads, translating multer errors into the
 * standard validation error envelope.
 */
export const uploadTransactionPhoto: RequestHandler = (req, res, next) => {
